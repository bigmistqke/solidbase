...
You can create interactive code examples that allow users to run and modify code directly in the browser by adding the `repl` attribute to your code tabs. This is perfect for creating live demos, tutorials, and interactive documentation.
...
- **Multi-file Support**: Include multiple JavaScript, CSS, and HTML files in a single REPL
- **Live Editing**: Modify code and see results instantly
- **Console Output**: View console.log and error messages in real-time
- **File Switching**: Switch between different files using the file tabs
- **Module System**: Use ES6 imports/exports between files
- **Error Handling**: Displays runtime errors with proper formatting

#### Single File Example

You can also create a simple single-file REPL:

**Input**

````md
```js tab repl title="demo.js"
...
document.body.innerHTML += '<h1 style="color: purple;">Live Demo!</h1>';
```
````
