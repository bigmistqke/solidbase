...
function SocialLinkView(props) {
    return (<a href={props.link} target="_blank" rel="noreferrer noopener">
			<Show when={props.type !== "custom"} fallback={<img alt={props.label} src={props.logo}/>}>
				<img alt={props.type} src={logos[props.type]}/>
			</Show>
		</a>);
}
