...
export function TabsComponent(props) {
    ...
    return (<Tabs.Root value={props.value?.()} onChange={props.onChange} class={styles["tabs-container"]}>
            ...
            return (<Tabs.Trigger class={styles["tabs-trigger"]} value={title}>
				...
				{props.withTsJsToggle && (<input type="checkbox" checked title="Toggle language" aria-label="Toggle TS/JS" class="sb-ts-js-toggle"/>)}
			</Tabs.List>
...
export function TabsWithPersistence(props) {
...
//# sourceMappingURL=TabsComponent.jsx.map