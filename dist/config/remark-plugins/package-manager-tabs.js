...
export function remarkPackageManagerTabs(packageManagers) {
    return (tree) => {
        if (packageManagers === false)
            return;
        ...
        visit(tree, (node, index, parent) => {
            if (node.type === "code") {
                if (!node.lang?.startsWith("package-"))
                    return;
                ...
                parent.children[index] = {
                    ...
                    name: "tab-group",
                    children: (resolvedManagers.show ?? []).map((preset) => {
                        return {
                            type: "containerDirective",
                            name: "tab",
                            children: [
...
//# sourceMappingURL=package-manager-tabs.js.map