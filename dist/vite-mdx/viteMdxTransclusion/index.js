...
import { remarkTransclusion } from "./remarkTransclusion.js";
/**
    ...
    const plugin = {
        ...
        buildStart() {
            ...
            globalMdxOptions.remarkPlugins.push(remarkTransclusion({
                ...
                getCompiler: (filePath) => createMdxAstCompiler(root, mergeArrays(globalMdxOptions.remarkPlugins, getMdxOptions?.(filePath).remarkPlugins)),
            }));
        },
    };
    return plugin;
